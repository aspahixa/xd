...
exports.run = async (client, message, args) => {
  ...
  if (!allowed)
    return    message.channel.send({embed:{title:` **__Permisija__**`,description:`Nemas permisiju za ovu komandu!!`, color: 0x36393f}})

  let member = message.mentions.members.first();
  if (!member) return message.channel.send({embed:{title:` **__Označi korisnika__**`,description:`Označi korisnika kog želiš mutirati`, color: 0x36393f}})
  let user = client.users.cache.get(member.id);
  if (message.member === member)
   return message.channel.send({embed:{title:` **__Greška__**`,description:`Ne možete sami sebe mutirati!`, color: 0x36393f}})

  let StaffPermisija = new Discord.MessageEmbed() 
    .setTitle(" Ne možeš koristiti ovu komandu na Administraciji!")
 ...
 let Vreme = new Discord.MessageEmbed() 
    .setTitle(" Nisi ispisao pravilno vreme")
  ...
  let VremeError1 = new Discord.MessageEmbed() 
    .setTitle(" Nije moguće koristiti kombinaciju vremenskih oznaka")
  ...
  let EnterReason = new Discord.MessageEmbed() 
    .setTitle(" Nisi napisao/la razlog")
 ...
 let AlreadyMuted = new Discord.MessageEmbed() 
    .setTitle(" Korisnik je već mutiran.")
