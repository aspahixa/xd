...
exports.run = async (client, message, args) => {
  ...
  if (args[0] == 0) return message.channel.send(embed5);
    ...
    let embedbank = new Discord.MessageEmbed()
      .setColor("#4CAAFF")
      .setDescription(
        " Nemaš nikakav novac za depozit!"
      );
    ...
    let embedall = new Discord.MessageEmbed()
      .setColor("#4CAAFF")
      .setDescription(` Prebacio/la si sav novac na banku!`);
    message.channel.send(embedall);
  } else {
    let embed2 = new Discord.MessageEmbed()
      .setColor("#4CAAFF")
      .setDescription(
        ` Napiši iznos koji želiš prebaciti na banku!`
      );
    ...
    let embed3 = new Discord.MessageEmbed()
      .setColor("#4CAAFF")
      .setDescription(
        ` Ne možeš prebaciti negativan novac!`
      );
    ...
    let embed4 = new Discord.MessageEmbed()
      .setColor("#4CAAFF")
      .setDescription(` Nemaš dovoljno novca za obavljanje ove radnje!`);
