  ...
  try {
    ...
    if (user) {
      message.guild.members
        .unban(user)
        .then(() => {
          return    message.channel.send({embed:{title:`**__Unbanovao/la si korisnika__**`,description:`*Uspešno si unbanovao/la korisnika sa servera* **__Elusive™ Community__**`, color: 0x36393f}})
      ...
      return    message.channel.send({embed:{title:`**__Greška__**`,description:`Nisi uneo/la **__ID KORISNIKA__** kojeg želiš unbanovati`, color: 0x36393f}})
    }
  } catch (err) {
