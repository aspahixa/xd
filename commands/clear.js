...
exports.run = async (client, message, args) => {
  ...
  if (!deleteCount || deleteCount < 1 || deleteCount > 100)
    return message.channel.send({embed:{title:` **__Brisanje poruka__**`,description:`Napiši broj poruka koje želiš izbrisati (1-100).`, color: 0x36393f}}); // So we get our messages, and delete them. Simple enough, right?
